...
class EmployeeCustomerInteraction extends StatefulWidget {
  const EmployeeCustomerInteraction({super.key});

  @override
  EmployeeCustomerInteractionState createState() =>
      EmployeeCustomerInteractionState();
}

class EmployeeCustomerInteractionState
    extends State<EmployeeCustomerInteraction> {
  @override
